...
var PullingDown = function () {
	...
	_createClass(PullingDown, [{
		...
		value: function start() {
			window.addEventListener('touchmove', this._preventWindowScroll, _util.eventOptions);
		...
		key: 'stop',
		value: function stop() {
			window.removeEventListener('touchmove', this._preventWindowScroll, _util.eventOptions);
